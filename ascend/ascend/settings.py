...
SECRET_KEY = 'django-insecure-74^vm!xva^36kks6u^k9=barr_cgn6adm&!7$+nx-56cvtgfsa'
...
DATABASES = {
    'default': dj_database_url.config(
        ...
        default='postgresql://postgres:postgres@localhost:5432/ascend',
        conn_max_age=600
    )
}
...
STATICFILES_DIRS = [
    ...
    os.path.join(BASE_DIR, 'ascend', 'static'),
]
#
if not DEBUG:
